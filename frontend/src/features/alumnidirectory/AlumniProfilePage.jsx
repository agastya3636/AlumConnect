    ...
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-r from-blue-500 to-purple-600">
      <div className="bg-white rounded-lg shadow-lg p-8 max-w-4xl w-full flex flex-col md:flex-row items-center justify-between">
        <div className="flex flex-col items-center md:items-start space-y-4 md:w-1/2">
          <h1 className="text-4xl font-bold text-gray-800">Welcome, Agastya!</h1>
          ...
          <div className="pt-8 w-full">
            <div className="mb-4 p-4 bg-yellow-100 border-l-4 border-yellow-500 rounded">
              ...
              <span className="text-gray-700">
                Email: <span className="font-mono">alumni@example.com</span>
              </span>
              <br />
              <span className="text-gray-700">
                Password: <span className="font-mono">alumni123</span>
              </span>
            </div>
            ...
            <div className="flex space-x-4 mt-2">
              ...
              <a
                href="https://linkedin.com/agastya"
                target="_blank"
              ...
              <a
                href="https://twitter.com/agastya"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://instagram.com/agastya"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://facebook.com/agastya"
                target="_blank"
                rel="noopener noreferrer"
          ...
          <div className="mt-8 w-full">
            ...
            <div className="mb-4">
              <iframe
                title="Location"
                src="https://maps.google.com/maps?q=Rajiv%20Gandhi%20Institute%20Of%20Petroleum%20Technology&t=&z=13&ie=UTF8&iwloc=&output=embed"
                width="100%"
                height="150"
                frameBorder="0"
                style={{ border: 0 }}
            ...
            <div className="flex flex-wrap gap-4">
              <div className="bg-gray-100 p-2 rounded shadow text-center w-32">
                John Doe
                <br />
